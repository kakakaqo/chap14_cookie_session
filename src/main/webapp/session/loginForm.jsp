...
<title>로그인</title>
   <script type="text/javascript">
      ...
      function fn_validate(){   
         //폼 객체의 주소값을 갖고 오는데 최고 상위 객체인  document 객체를 통해서 갖고옴
         var frmLogin = document.frmLogin; // neme = frmLogin인 엘리먼트 주소
...
<body>
   <form name="frmLogin" method="post" 
         action="${contextPath}sessionLogin">
